...
def smplify_runner(
    ...
    print('Running Temporal SMPLify...')
...
def video_to_images(vid_file, img_folder=None, return_info=False):
    print(f'Converting video to images: {vid_file}')
...
def images_to_video(img_folder, output_vid_file):
    print(f'Converting images to video: {output_vid_file}')
    os.makedirs(img_folder, exist_ok=True)
...
def convert_crop_cam_to_orig_img(cam, bbox, img_width, img_height):
    print('Converting predicted camera from cropped image coordinates to original image coordinates')
    '''
...
def convert_crop_coords_to_orig_img(bbox, keypoints, crop_size):
    print('Converting keypoints from cropped image coordinates to original image coordinates')
...
def prepare_rendering_results(vibe_results, nframes):
    print('Preparing rendering results')
