...
class Content(BaseModel):
   ...
   cache_file_path = CharField(null=True)  # Added cache_file_path field
   ...
   @classmethod
   def add(cls, title, thumbnail, type, data, cache_file_path=None):
       with db.connection_context():
   ...
   def update(self, id, title=None, thumbnail=None, type=None, data=None, cache_file_path=None):
       with db.connection_context():
           update_dict = {}
           ...
           if cache_file_path is not None:
               update_dict['cache_file_path'] = cache_file_path
